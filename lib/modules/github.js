...
exports.setup = function(everyauth, config) {
  ...
  if(requiredOrganization) {
    log.notice(config.domain + " registered Github authentication for members of organizations: " + requiredOrganization.join(", "));
  }
  if(requiredEmail) {
    log.notice(config.domain + " registered Github authentication for users: " + requiredEmail.join(", "));
  }
};
