...
var checkDomain = function(auth) {
  ...
  for(var i = 0; i < conf.modules.google.requiredEmail.length; i++) {
    var permEmail = conf.modules.google.requiredEmail[i];
    if(auth.google.user.email == permEmail) { return true; }
  }
